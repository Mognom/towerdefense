			...
			for (int x = 0; x< map.GetLength(1); x++) 
				...
				switch(map[z,x]){
					...
					case 3:
						...
						if(x+1 < map.GetLength(1) && map[z,x+1] == 1)
							rotation = Quaternion.Euler(-90,-90,0);
						else
							if(x-1 > 0 && map[z,x-1] == 1)
								rotation = Quaternion.Euler(-90,90,0);
							else
								if(z+1 < map.GetLength(0) && map[z+1,x] == 1)
					...
					case 5:
						...
						if(x+1 < map.GetLength(1) && z+1 < map.GetLength(0) && map[z+1,x+1] == 1)
							rotation = Quaternion.Euler(-90,270,0);
						
						//Esquina derecha abajo
						else if(x+1 < map.GetLength(1) && z-1 > 0 && map[z-1,x+1] == 1)
							rotation = Quaternion.Euler(-90,180,0);
						
						//Esquina izquierda arriba
						else if(x-1 > 0 && z+1 < map.GetLength(0) && map[z+1,x-1] == 1)
							rotation = Quaternion.Euler(-90,0,0);
						
						//Esquina izquierda abajo
						else if(x-1 > 0 && z-1 > 0 && map[z-1,x-1] == 1)
							rotation = Quaternion.Euler(-90,90,0);
					...
					case 6:
						rotation = border.transform.rotation;
						//Esquina derecha arriba
						if(x+1 < map.GetLength(1) && z+1 < map.GetLength(0) && map[z+1,x] == 1 && map[z,x+1] == 1)
							rotation = Quaternion.Euler(-90,0,0);
						
						//Esquina derecha abajo
						else if(x+1 < map.GetLength(1) && z-1 > 0 && map[z-1,x] == 1 && map[z,x+1] == 1)
							rotation = Quaternion.Euler(-90,270,0);
						
						//Esquina izquierda arriba
						else if(x-1 > 0 && z+1 < map.GetLength(0) && map[z+1,x] == 1 && map[z,x-1] == 1)
							rotation = Quaternion.Euler(-90,90,0);
						
						//Esquina izquierda abajo
						else if(x-1 > 0 && z-1 > 0 && map[z-1,x] == 1 && map[z,x-1] == 1)
							rotation = Quaternion.Euler(-90,180,0);
